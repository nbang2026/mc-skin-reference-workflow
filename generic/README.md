...
#    2) Copy both skills into your agent's skills dir (Claude Code shown)
...
**中文**：采用标准 `SKILL.md` 格式，可放进任意兼容的智能体。
**English**: Standard `SKILL.md` layout — drop it into any compatible agent.
